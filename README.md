...
<img width="729" height="246" alt="image" src="https://github.com/user-attachments/assets/eef193bc-2a47-4f98-a1c3-756cda74bb54" />
...
<img width="714" height="246" alt="image" src="https://github.com/user-attachments/assets/52f6c076-fadb-45f7-bf66-c843b7e54b72" />
...
Маючиiнформацiюпротопологiю мережi (якi вузли з’єднанi з якими, i яка затримка
...
3 ≤N ≤1000, 2≤M ≤1000
• Другий рядок мiстить перелiк цiлих чисел, роздiлених пробiлом 
вузлiв, якi є клiєнтами. Усi вузли в мережi нумеруються вiд 1 до N.
номери
• НаступнiM рядкiвмiстятьтрiйкинатуральнихчисел startnode, endnode, latency
номер початкового вузла, кiнцевого вузла та затримка для кожного з’єднання.
1 ≤latency ≤ 109.
Вихiднi данi
Вихiдний файл gamsrv.out повинен мiстити одне число мiнiмальнезначеннянайбiльшої
